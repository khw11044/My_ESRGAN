...
def train_fn(
    ...
    for idx, (low_res, high_res) in enumerate(loop):
        ...
        row_res = row_res.to(config.DEVICE)
        ...
        opt_disc.zero_grad()
        d_scaler.scale(loss_critic).backward(0)
        ...
        writer.add_scaler("Critic loss", loss_critic.item(), global_step=tb_step)
        tb_step += 1
        
        if idx % 100 == 0 and idx>0:
            plot_examples("text_images/", gen)
